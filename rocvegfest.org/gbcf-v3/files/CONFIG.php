...
##################################################################
    ...
    $send_email    = "contact-us@rocvegfest.org";       // Your email

    $reply_email   = "contact-us@rocvegfest.org";   // Reply email
...
##################################################################
    ...
    $addressee     = "Rochester VegFest";   // Your name/Company name

    $web_site      = "rocvegfest.org";     // Your site or company name
...
##################################################################
    ...
    $spam_question = "What color is an eggplant?";
...
// work for all. This is an ongoing issue.
    ...
    $add_antiflood = "yes";        // Or "yes" (if needed)

    $flood_level   = 9;           // 0-9 seconds before refresh

    $neg_f_param   = "no";       // Or "no" (if needed)

    $smtp_sneak    = "yes";        // Or "yes" (if needed)

    $ini_set       = "yes";        // Or "yes" (if needed)

    $smtp          = "localhost"; // Confirm with your host

    $smtp_port     = "25";        // Confirm with your host

    $smtp_password = "";    // If needed, ask host

    $smtp_username = "";     // If needed, ask host

    $sendmail_from = "contact-us@rocvegfest.org";   // Your email
